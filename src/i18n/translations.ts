...
export const translations = {
  uk: {
    ...
    services: {
      ...
      landingDesc: 'Односторінковий промо-сайт з високою конверсією. Від $600.',
      corporateTitle: 'Корпоративний сайт',
      corporateDesc: 'Багатосторінковий бізнес-ресурс з блогом. Від $1200.',
      ecommerceTitle: 'E-commerce Магазин',
      ecommerceDesc: 'Магазин з кошиком, кабінетом та оплатами. Від $1800.',
      pagesLabel: 'Кількість унікальних сторінок',
      page1: '1 сторінка',
      page30: '30 сторінок',
      devopsAddon: 'Налаштування DevOps та CDN (+ $300)',
      devopsAddonDesc: 'Docker, SSL, кешування Cloudflare та надійний хостинг.',
      smmAddon: 'SMM Старт & SEO Оптимізація (+ $400)',
      smmAddonDesc: 'Аналіз аудиторії, налаштування реклами, первинне SEO.',
      apiAddon: 'Інтеграції API та CRM систем (+ $500)',
    ...
    contact: {
      ...
      location: 'Київ, Україна (Працюємо по всьому світу)',
      nameLabel: "Ваше ім'я",
      ...
      budgetLess: 'до $1,000',
      budget1k: '$1,000 - $3,000',
      budget3k: '$3,000 - $7,000',
      budgetMore: 'понад $7,000',
      ...
      successDesc: 'Дякуємо, {name}. Наш менеджер зв\'яжеться з вами протягом 30 хвилин для уточнення деталей.',
      ...
      faq3a: 'Так, наш DevOps-інженер Данило забезпечує постійний моніторинг стабільності сайту, автоматичні бекапи баз даних, захист від DDoS атак та оперативне оновлення модулів безпеки у разі потреби.',
  ...
  en: {
    ...
    services: {
      ...
      landingTitle: 'Landing Page',
      landingDesc: 'Single-page promo site with high conversion. From $600.',
      corporateTitle: 'Corporate Website',
      corporateDesc: 'Multi-page business resource with a blog. From $1200.',
      ecommerceTitle: 'E-commerce Store',
      ecommerceDesc: 'Store with cart, account & payments. From $1800.',
      pagesLabel: 'Number of unique pages',
      page1: '1 page',
      page30: '30 pages',
      devopsAddon: 'DevOps & CDN Setup (+ $300)',
      devopsAddonDesc: 'Docker, SSL, Cloudflare caching & reliable hosting.',
      smmAddon: 'SMM Starter & SEO (+ $400)',
      smmAddonDesc: 'Audience analysis, ad setup, initial SEO.',
      apiAddon: 'API & CRM Integrations (+ $500)',
    ...
    contact: {
      ...
      location: 'Kyiv, Ukraine (We work worldwide)',
      nameLabel: 'Your Name',
      ...
      budgetLess: 'Under $1,000',
      budget1k: '$1,000 - $3,000',
      budget3k: '$3,000 - $7,000',
      budgetMore: 'Over $7,000',
      messageLabel: 'Describe your project',
      messagePlaceholder: 'Hi, I need a website built...',
      submitBtn: 'Send Request',
      successTitle: 'Request Sent!',
      successDesc: "Thank you, {name}. Our manager will contact you within 30 minutes to clarify the details.",
