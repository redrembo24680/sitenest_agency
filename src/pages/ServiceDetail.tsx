...
interface ServiceDetailProps {
  serviceId: 'frontend' | 'backend' | 'devops' | 'smm';
  navigateTo: (page: string) => void;
}

export const ServiceDetail: React.FC<ServiceDetailProps> = ({ serviceId, navigateTo }) => {
  const { t } = useLanguage();
  ...
  if (!serviceData) {
    return (
      <div className="container" style={{ padding: '8rem 2rem', textAlign: 'center' }}>
        ...
        <button className="btn btn-outline" style={{ marginTop: '2rem' }} onClick={() => navigateTo('services')}>
      ...
      <section className="services-hero">
        <div className="container" style={{ textAlign: 'left', position: 'relative' }}>
          <button 
            ...
            style={{ marginBottom: '2.5rem', padding: '0.5rem 1.25rem', fontSize: '0.85rem' }} 
