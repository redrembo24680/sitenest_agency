...
const TESTIMONIALS_DATA = {
  uk: [
    ...
    },
    {
      ...
      text: 'Марія та команда SMM повністю перетворили наш Instagram. За 4 місяці — з 1200 підписників до 34K органічно. Таргет дає ROAS 4.5x. Дуже рекомендую!',
      rating: 5,
      initials: 'МК',
    },
    {
      ...
      text: 'Артем розробив бекенд, який спокійно витримує пікові навантаження в Чорну П\'ятницю — 8000+ замовлень одночасно без жодного збою. Це рівень великих компаній.',
      rating: 5,
      initials: 'ІД',
    },
    {
      ...
      role: 'CTO, FinEdge',
      text: 'DevOps-налаштування від Данила скоротили наші витрати на AWS на 38% і час деплою з 40 хвилин до 3. Kubernetes кластер працює бездоганно вже рік.',
      rating: 5,
      initials: 'НР',
    },
  ],
  en: [
    ...
    },
    {
      ...
      role: 'Marketing Director, BrandUp',
      text: 'Maria and the SMM team completely transformed our Instagram. In 4 months — from 1,200 followers to 34K organically. Targeting delivers 4.5x ROAS. Highly recommended!',
      rating: 5,
      initials: 'MK',
    },
    {
      name: 'Igor Dmytrenko',
      role: 'Founder, NestMall',
      text: "Artem built a backend that easily handles peak Black Friday loads — 8000+ simultaneous orders with zero downtime. This is enterprise-level engineering.",
      rating: 5,
      initials: 'ID',
    },
    {
      ...
      role: 'CTO, FinEdge',
      text: "Danilo's DevOps setup cut our AWS costs by 38% and deployment time from 40 minutes to 3. The Kubernetes cluster has been running flawlessly for a year.",
      rating: 5,
      initials: 'NR',
    },
  ],
