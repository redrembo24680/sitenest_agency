...
export const translations = {
  uk: {
    ...
    web3: {
      subtitle: 'інновації',
      title: 'SiteNest',
      titleHighlight: 'Web3 & NFT Club',
      desc: 'Отримайте лімітований NFT нашого агентства та розблокуйте довічні знижки на розробку, пріоритетну підтримку та безкоштовний хостинг.',
      connectWallet: 'Підключити гаманець',
      disconnectWallet: 'Відключити',
      mintNft: 'Придбати VIP-картку',
      minting: 'Мінтинг...',
      alreadyMinted: 'Придбано!',
      vipActive: 'Активовано статус VIP-Клієнта (Знижка 15%)',
      benefitsTitle: 'Привілеї для власників NFT',
      benefit1Title: 'Знижка 15% на розробку',
      benefit1Desc: 'Довічна знижка на будь-які послуги агентства: від Landing Page до великих порталів.',
      benefit2Title: 'Пріоритетна черга',
      benefit2Desc: 'Ваші таски йдуть першими. Початок розробки протягом 48 годин після запиту.',
      benefit3Title: '1 рік хостингу & підтримки',
      benefit3Desc: 'Безкоштовне розміщення вашого сайту, моніторинг стабільності та бекапи.',
      benefit4Title: 'DAO голосування',
      benefit4Desc: 'Голосуйте за напрямки розвитку нашого агентства та спільні open-source проекти.',
      forClientsTitle: 'Бажаєте інтегрувати Web3 у свій бізнес?',
      forClientsDesc: 'Ми допомагаємо компаніям запускати власні NFT-колекції, інтегрувати оплату криптовалютою (USDT/USDC/ETH/SOL) та розробляти програми лояльності на блокчейні Base та Solana.',
      orderWeb3: 'Обговорити Web3 проект',
      cardTitle: 'SiteNest Member Pass',
      cardOwner: 'Власник',
      cardStatus: 'Статус',
      statusInactive: 'Не підключено',
      statusActive: 'VIP Член',
      priceLabel: 'Ціна карти',
      priceValue: 'Безкоштовно (Симуляція)',
      supplyLabel: 'Доступна кількість',
      supplyValue: '172 з 500',
      perksLabel: 'Привілеї',
    },
  },
  ...
  en: {
    ...
    web3: {
      ...
      title: 'SiteNest',
      titleHighlight: 'Web3 & NFT Club',
      desc: 'Get a limited-edition NFT from our agency and unlock lifetime development discounts, priority support, and free hosting.',
      connectWallet: 'Connect Wallet',
      disconnectWallet: 'Disconnect',
      mintNft: 'Buy VIP Pass',
      minting: 'Minting...',
      alreadyMinted: 'Already Owned!',
      vipActive: 'VIP Client Status Activated (15% Discount)',
      benefitsTitle: 'Privileges for NFT Holders',
      benefit1Title: '15% Lifetime Discount',
      benefit1Desc: 'Lifetime discount on all agency services: from Landing Pages to large platforms.',
      benefit2Title: 'Priority Development Queue',
      benefit2Desc: 'Your tasks go first. Development starts within 48 hours of request.',
      benefit3Title: '1 Year Free Hosting & Support',
      benefit3Desc: 'Free hosting setup, stability monitoring, and backups for your website.',
      benefit4Title: 'DAO Voting Rights',
      benefit4Desc: 'Vote on our agency\'s product roadmap and community open-source projects.',
      forClientsTitle: 'Want to Integrate Web3 into Your Business?',
      forClientsDesc: 'We help companies launch their own NFT collections, integrate cryptocurrency payments (USDT/USDC/ETH/SOL), and develop blockchain loyalty programs on Base and Solana.',
      orderWeb3: 'Discuss Web3 Project',
      cardTitle: 'SiteNest Member Pass',
      cardOwner: 'Owner',
      cardStatus: 'Status',
      statusInactive: 'Not Connected',
      statusActive: 'VIP Member',
      priceLabel: 'Card Price',
      priceValue: 'Free (Simulation)',
      supplyLabel: 'Available Supply',
      supplyValue: '172 of 500',
      perksLabel: 'Privileges',
    },
  },
} as const;
