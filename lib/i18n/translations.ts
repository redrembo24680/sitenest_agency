...
export const translations = {
  uk: {
    ...
    contact: {
      ...
      successDesc: 'Дякуємо, {name}. Ми надіслали лист на вашу пошту. Будь ласка, перейдіть за посиланням у листі для підтвердження заявки.',
  ...
  en: {
    ...
    contact: {
      ...
      successDesc: "Thank you, {name}. We have sent an email to your address. Please click the link in the email to confirm your request.",
